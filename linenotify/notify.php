...
$token = "BTmFR3acWhJtrxGzOuT74Mqzhdp08BrDwepHIQvVzwq"; //ใส่Token ที่copy เอาไว้
$str = $notify; //ข้อความที่ต้องการส่ง สูงสุด 1000 ตัวอักษร
...
<?php //กำหนดเงื่อนไข แจ้งเตือนไลน์
